...
ifeq ($(strip $(PROJECT_NAME)),)
	...
	@git clone git@github.com:mbah24-dev/ForgeMaker-Executable.git $(PROJECT_NAME)/.genMake
	@cd $(PROJECT_NAME) && ./.genMake/releases/updateMakefile $(PROJECT_NAME)
	@cp $(PROJECT_NAME)/.genMake/releases/updateMakefile $(PROJECT_NAME)/updateMakefile 
